...
var App = function () {
	...
	if (path.indexOf('/embrace2')==0) {
		var ctx = path.split('/')[1];
		rootcontext = "/" + ctx + "/";
	}
    window.CKEDITOR_BASEPATH = rootcontext+'/assets/js/lib/ckeditor/';
    ...
    //Handles bootstrap popover transitions
    var handlePopoverTransitions = function () {
        if($.fn.popover.Constructor) {
        	var orig = $.fn.popover;
        	var proto = $.extend({}, $.fn.popover.Constructor.prototype);
    ...
    return {
        ...
        init: function () {
            ...
            handlePopoverTransitions(); // handle bootstrap popover transition effects
        },
