...
define([ "hide-show",
    ...
    "jquery.dataTables","xlsx-export","table-export","DT_bootstrap",
    "app1", "form-validation", "components-pickers", "components-dropdowns",
    "form-fileupload", "login", "table-managed","additional-methods","format-currency","colorbox"
    ], function() {
        App.init();
        /*FormValidation.init();*/
