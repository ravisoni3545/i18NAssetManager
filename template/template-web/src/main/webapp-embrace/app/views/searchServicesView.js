define(["text!templates/searchServices.html", "backbone","app","models/serviceModel","collections/servicesCollection"],
	...
	var servicesView = Backbone.View.extend( {
		...
		populateView: function() {
			...
			if(this.responseObj==null){
				...
				this.responseObj=allServicesResponseObject;
			}
			else{
				allServicesResponseObject=this.responseObj;
			}
		...
		render : function (el) {
			...
			this.template = _.template( servicesTemplate, { services: {	availableServices:this.availableServicesList.toJSON()} });
			this.$el.html("");
